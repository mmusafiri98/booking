...
class getSass_CssAssetCompilerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['sass.css_asset_compiler'] = new \Symfonycasts\SassBundle\AssetMapper\SassCssCompiler([(\dirname(__DIR__, 4).'/assets/styles/app.scss')], (\dirname(__DIR__, 3).'/sass'), ($container->privates['sass.builder'] ?? $container->load('getSass_BuilderService')));
    }
}
