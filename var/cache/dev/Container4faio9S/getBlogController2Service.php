...
class getBlogController2Service extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.mm2jLcA'] ?? $container->load('get_ServiceLocator_Mm2jLcAService'))->withContext('App\\Controller\\BlogController', $container));
